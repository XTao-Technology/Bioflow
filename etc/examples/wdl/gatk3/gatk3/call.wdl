...
workflow VarationCall {
    ...
    call picardtool.picard_merge_tool as MergeBams {
        input: inputBamFiles=SortBam.bam
    }
    ...
    call gatktool.ReAlignTargetCreator as ReAlignTarget {
        input: inputBamFile=MergeBams.bam, reference=reference, knownSiteFile1=siteFile1, knownSiteFile2=siteFile2, knownSiteFile3=siteFile3, indexFile=IndexBam.index
    }
